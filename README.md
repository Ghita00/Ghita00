...
## Sono uno sviluppatore di Altivole(TV) e mi occupo di sviluppo web. Lavoro presso Almaviva Digital Tech, azienda di consulenza informatica a Mestre(VE) e nel frattempo stò concludendo il mio percorso di studi presso l'università d'informatica Ca Foscari(VE)🙋‍♂️

## Progetti personali
- 🔭  [Progetto della tesi: Gestionale per una pasticceria](https://github.com/Ghita00/Tirocinio)
- 💻  [Progetto database](https://github.com/Ghita00/FlexGym)
- ⚙️  [Progetto ingegneria del software](https://github.com/Ghita00/MasterDevs)
- ☕  [Esercitazione di java](https://github.com/Ghita00/DungeonGenerator)
...
### Formazione 👨‍🏫
**Università Ca' Foscari - Informatica**  
*Settembre 2019 - Oggi*
Sto svolgendo la mia formazione presso l'università di Ca' Foscari, percorso di studi informatico triennale.

### Esperienze Lavorative 🧑‍💻
**Sviluppatore Full Stack presso Almaviva Digital Tech**  
*Ottobre 2022 - Oggi*

Realizzo software per le pubbliche amministrazioni delle diverse regioni italiane, come la regione Veneto e la regione Campania. Durante il mio percorso ho imparato:
...
- Sviluppare seguendo delle codeline chiare e standardizzate.
- Sviluppare sui diversi stack di competenza utilizzando tecnologie sempre diverse.

**Sviluppo Progetto di Tesi e Tirocinio**  
*Maggio 2022 - Settembre 2022, 4 mesi*

Durante questo progetto ho avuto la possibilità di sviluppare un gestionale per una pasticceria, composto sia da una parte di front office, dove i visitatori possono osservare i prodotti e leggere gli articoli pubblicati, sia da una parte di back office, dove il titolare può gestire la visualizzazione delle informazioni, la produzione, le giacenze di magazzino e gli stipendi dei dipendenti. Durante questo progetto ho imparato:
...
**Sviluppo Siti per Liberi Professionisti e Aziende**  
*Attività sporadica*

Ho realizzato diversi siti web per liberi professionisti e PMI utilizzando sia tecnologie "code" che "no-code". In questa esperienza ho imparato:
- Relazionarmi con le aziende e  con gli imprenditori.
- Autogestirmi il carico e le tempistiche.
- Comprendere le priorità di progetto.
- Stimare i diversi task con maggior attenzione.
